...
export class TboRoomService {
    ...
    async searchRoomQuote(quoteRequest: any, providerCredentials: any): Promise<HotelRoomQuoteResponse> {
        ...
        try {
            ...
            // rateKey is TBO's own BookingCode, returned as-is from TBO's Search response;
            // TBO's PreBook expects that full composite string back unchanged
            const bookingCode = rateKey;
